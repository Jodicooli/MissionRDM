...
import Phone from '@/components/PhoneComponent.vue'
import PhoneMessage from '@/components/PhoneMessageComponent.vue'
import PhoneKeypad from '@/components/PhoneKeypadComponent.vue'
import ScenarioDisplay from '@/components/ScenarioScreenCoponent.vue'
import RiddleModal from '@/components/RiddleModalComponant.vue'
import PhoneCall from '@/components/PhoneCallComponent.vue'
