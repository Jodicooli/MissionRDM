...
describe('useHintsSolutionsLvl1', () => {
  ...
  describe('getCurrentStep logic', () => {
    ...
    it('returns "sixth" when code 21 entered but not 26', () => {
      store.enteredCodes = ['21']
      
      expect(hints.getCurrentStep()).toBe('sixth')
    })

    it('returns "seventh" when code 26 entered but not 28', () => {
      store.enteredCodes = ['26']
      
      expect(hints.getCurrentStep()).toBe('seventh')
    })

    it('returns "eigth" when code 28 entered but not 88', () => {
      store.enteredCodes = ['28']
      
      expect(hints.getCurrentStep()).toBe('eigth')
    })
