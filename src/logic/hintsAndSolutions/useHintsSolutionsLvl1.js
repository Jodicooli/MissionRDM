...
export function useHintsSolutionsLvl1() {
  ...
  const getCurrentStep = () => {
    ...
    if (codes.includes('28') && !codes.includes('88')) {
      return 'eigth'
    }

    // Step 7: Has code 26, looking for code 28
    if (codes.includes('26') && !codes.includes('28')) {
      return 'seventh'
    }

    // Step 6: Has code 21, looking for code 26
    if (codes.includes('21') && !codes.includes('26')) {
      return 'sixth'
    }

    // Step 5: Riddle solved, looking for code 21
    if (game.riddleSolved && !codes.includes('21') && codes.includes('8') && codes.includes('4')) {
      return 'fifth'
    }
